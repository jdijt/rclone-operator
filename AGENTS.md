# rclone-operator - AI Agent Guide

> **Read [CLAUDE.md](CLAUDE.md) first.** This file is the generic kubebuilder agent guide that
> came with the scaffold. `CLAUDE.md` holds the project-specific AI usage policy (this is a
> learning project: AI reviews and advises, the author writes the production Go) and takes
